...
# create spec file
save_dir = "/home/dasienga24/Statistics-Senior-Honors-Thesis/Python/COMPAS Application/equalized_odds_0.1"
...
# create spec file
save_dir = "/home/dasienga24/Statistics-Senior-Honors-Thesis/Python/COMPAS Application/equalized_odds_0.05"
...
# create spec file
save_dir = "/home/dasienga24/Statistics-Senior-Honors-Thesis/Python/COMPAS Application/equalized_odds_0.01"
...
# load the spec file
specfile = '/home/dasienga24/Statistics-Senior-Honors-Thesis/Python/COMPAS Application/equalized_odds_0.2/spec.pkl'
...
# load the spec file
specfile = '/home/dasienga24/Statistics-Senior-Honors-Thesis/Python/COMPAS Application/equalized_odds_0.1/spec.pkl'
spec = load_pickle(specfile)
...
# load the spec file
specfile = '/home/dasienga24/Statistics-Senior-Honors-Thesis/Python/COMPAS Application/equalized_odds_0.01/spec.pkl'
spec = load_pickle(specfile)
...
We got a solution! Therefore, we are 95% confident that the equalized odds -- 'abs((FNR | [Black]) - (FNR | [White])) + abs((FPR | [Black]) - (FPR | [White])) -- <= 0.01'. Notice that the log odds is larger than before.
...
# load the spec file
specfile = '/home/dasienga24/Statistics-Senior-Honors-Thesis/Python/COMPAS Application/equalized_odds_0.05/spec.pkl'
spec = load_pickle(specfile)
...
We got a solution! Therefore, we are 95% confident that the equalized odds -- 'abs((FNR | [Black]) - (FNR | [White])) + abs((FPR | [Black]) - (FPR | [White])) -- <= 0.05'. 
...
This means that ~32% of defendants are misclassified in the incorrect recidivism prediction. 
### epsilon = 0.1
...
The false positive rates gain more parity as we tighten $\epsilon$, but we lose model accuracy! The key question this brings up is: how do we balance these trade-offs? 
...
However, as we tighten $\epsilon$, this discrepancy begins to disappear and we get fairer results at the cost of the FNR. At a certain threshold, the model just classifies everything into the negative class. 

...
```{r, include = FALSE}
write_csv(compas, "/home/dasienga24/Statistics-Senior-Honors-Thesis/Data Sets/COMPAS/compas_data_clean.csv")
```
...
```{python}
# function that gets an initial solution to constrain 
def initial_solution_fn(model,features,labels):
    return model.fit(features,labels)

# specify data path
data_pth = "/home/dasienga24/Statistics-Senior-Honors-Thesis/Data Sets/COMPAS/compas_data_clean.csv"
save_dir = '.'

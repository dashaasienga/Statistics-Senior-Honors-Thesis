...
Consistent with the set-up in Section \@ref(toy) and following the presentation by @aisafety, the aim of the experimentation in this section is to assess three aspects of the quasi-Seldonian linear regression algorithm defined in Section \@ref(toy): performance loss, frequency of solutions, and frequency of undesirable behavior for varying sample sizes. 

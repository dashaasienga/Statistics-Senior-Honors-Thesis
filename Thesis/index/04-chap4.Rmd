...
```{r ch4fig2, echo = FALSE, fig.width = 6.3, fig.height = 6, warning = FALSE, message = FALSE, fig.cap = "The Distribution of the Discrimination Statistic of Convergent Seldonian Solutions by Sample Size"}
# visualization
sim_results_converged_disc |>

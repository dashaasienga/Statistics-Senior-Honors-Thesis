...
mycordata <- compas_data_gg %>%
  rename("Misdemeanors" = juv_misd_count,
         "Felonies" = juv_fel_count,
         "Other" = juv_other_count,
         "Priors" = priors_count) %>%
  select_("Misdemeanors", "Felonies", "Other", "Priors")

cor(mycordata) %>%
  kable(digits = 2,
        caption = "COMPAS Covariate Correlation Structure",
        booktabs = TRUE)
```

\noindent Figure \@ref(fig:ch3fig2) displays recidivism by race to explore the relationship between $Y$ and $A$.

```{r ch3fig2, warning = FALSE, message = FALSE, echo = FALSE, fig.align='center', fig.cap="Recidivism by Race", warning = FALSE, message = FALSE, fig.width = 4.5, fig.height = 3}
...
```{r ch3fig3, warning = FALSE, message = FALSE, echo = FALSE, fig.align='center', fig.cap="Prior Offenses by Race", warning = FALSE, message = FALSE, fig.width = 4.5, fig.height = 3}
...
```{r ch3fig4, warning = FALSE, message = FALSE, echo = FALSE, fig.align='center', fig.cap="Prior Offenses by Recidivation", warning = FALSE, message = FALSE, fig.width = 4.5, fig.height = 3}
ggplot(data = compas_data_gg, mapping = aes(x=priors_count)) +
  geom_histogram() +
  theme_minimal() +
  labs(x = "Priors") +
  facet_wrap( ~ as.factor(is_recid))
```

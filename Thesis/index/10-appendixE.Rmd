...
# one hot encode categorical features, scale numerical features using standard scaler 
...
```{python, eval = FALSE}
# get the solution -- can be repeated for the different epsilon values
...
```{python, eval = FALSE}
# store the results 
seldonian_results = pd.DataFrame({'is_recid': y_outdf, 'pred_0.2': pred_probs_02, 
'pred_0.1': pred_probs_01, 'pred_0.05': pred_probs_005, 'pred_0.01': pred_probs_001})

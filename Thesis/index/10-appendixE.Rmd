...
\noindent This appendix section walks through how a Seldonian algorithm was fit on the COMPAS data set in Chapter \@ref(chap-3) — the algorithm aimed to produce less disparate outcomes in error rates between Black and White defendants. The code was adapted from @aisafety.

...
\noindent In addition to the above corrections, the notation for an algorithm was changed from $a \in \textbf{A}$ to $\textbf{a} \in \textbf{A}$ in approximately 7 places to avoid confusion with the notation for demographic groups $a, b \in A$. 

\noindent Finally, 2 spellin corrections were made in the thesis. 

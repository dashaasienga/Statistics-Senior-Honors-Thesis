...
In addition to the above corrections, the notation for an algorithm was changed from $a \in \textbf{A}$ to $\textbf{a} \in \textbf{A}$ in approximately seven places to avoid confusion with the notation for demographic groups $a, b \in A$. Finally, three spelling corrections were made in the thesis. 
